              ...
              <div css={editorVisible==1?css`display:flex; flex-direction: column; width: 100%; height:100%`:css`display:none;`}>
                ...
                <div className="editor_footer">
                  <div css={css`display: flex; flex-direction: row`}>.
                    <label className="input-file-button" for="input-file">업로드</label><input id="input-file" type="file" onChange={e => handleChangeFile2(e.target.files[0])} accept = ".py" style={{display:"none"}}/>
